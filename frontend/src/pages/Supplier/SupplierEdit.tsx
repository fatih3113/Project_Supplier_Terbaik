...
import type { Supplier } from './SupplierIndex';
...
const SupplierEdit: React.FC<Props> = ({ supplier, onSuccess, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 animate-in fade-in zoom-in-95">
        <h3 className="text-lg font-bold mb-4">Edit Data Supplier</h3>
